  ...
  render() {
    return (
      <div className="About">
        ...
        As a former NCAA Divison 1 soccer player and team captian, I know discipline and determination. I set goals and when I reach those goals, I set some more.
        <br />
        <br />
